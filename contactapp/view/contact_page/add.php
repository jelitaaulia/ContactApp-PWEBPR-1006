...
<body class="h-screen bg-slate-200 flex flex-row">
  ...
  <main class="flex flex-col w-full">
    <p class="text-3xl font-bold text-blue-600 p-4 my-6 mx-10">Add Contact</p>

    <div class="flex justify-center mt-10">
      <form action="../../view/contact_page/addact.php" method="post" class="w-[500px] bg-white p-8 rounded-lg shadow-lg">
        <div class="mb-4">
    ...
    <div class="flex justify-center mt-6">
      <a href="../../view/contact_page/index.php" class="text-blue-600 hover:text-blue-800">
        Back to Dashboard
      </a>
    </div>
  </main>
