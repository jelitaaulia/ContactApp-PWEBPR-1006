...
<body class="h-screen bg-slate-200 flex flex-row">
  ...
  <main class="flex flex-col w-full">
    ...
    <div class="flex justify-center mt-10">
      <form action="../../view/contact_page/editact.php" method="post" class="w-[500px] bg-white p-8 rounded-lg shadow-lg">
    ...
    <div class="flex justify-center mt-6">
      <a href="../../view/contact_page/index.php" class="bg-blue-600 text-white font-medium py-2 px-4 rounded-lg hover:bg-blue-800">
        Back to Dashboard
      </a>
    </div>
  </main>
